...
/mob/dead/new_player/proc/make_me_an_observer()
	...
	var/this_is_like_playing_right = alert(src,"Are you sure you wish to observe? You will not be able to play the same character this round unless you cryo'd! You are also not allowed to meta-game!","Player Setup","Yes","No")
